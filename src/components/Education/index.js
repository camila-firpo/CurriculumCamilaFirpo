    ...
    <Card variant="outlined" sx={{ my: 3 }}>
      ...
      <Box>
        ...
        <Box sx={{ margin: 1, padding: 1 }}>
          ...
          >
            Information Technologist | 2021 - Present
          </Typography>
          <Box sx={{ margin: 1 }}>
            <Typography variant="body1" color="secondary.dark">
              Student with the first year completely approved
            </Typography>
          </Box>
        </Box>
      </Box>
      <Box>
        ...
        <Box sx={{ margin: 1, padding: 1 }}>
          <Typography
            ...
            sx={{ marginBottom: 1, fontWeight: 600 }}
          >
            Bachelor of Economics | 2014 - Paused
          </Typography>
      ...
      <Box>
        ...
        <Box sx={{ margin: 1, padding: 1 }}>
          <Typography
            ...
            sx={{ marginBottom: 1, fontWeight: 600 }}
          >
            Accounting Assistant | 2012 - Finalized
          </Typography>
          <Typography
            variant="subtitle1"
            color="secondary.dark"
          ...
          >
            {' '}
            Administrative Assistant | 2013 - Finalized
          </Typography>
          <Typography
            variant="subtitle1"
            color="secondary.dark"
            sx={{ marginBottom: 1, fontWeight: 600 }}
          >
            Directors Assistant | 2013 - Finalized
          </Typography>
        </Box>
      </Box>
    </Card>
