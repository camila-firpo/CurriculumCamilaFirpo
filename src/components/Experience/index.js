            ...
            <Card variant="outlined" sx={{my: 3}}>
                ...
                <Box>
                    ...
                    <Box sx={{ margin: 1 , padding: 1}}>
                        <Typography variant="subtitle1" color="secondary.dark">Accounting Assistant, July 2015-Present</Typography>
                        <Box sx={{ color:"secondary.dark", variant:"body1" }}>
                          <List  sx={{ width: '100%', bgcolor: 'background.paper' }} dense>
                            <ListItem>
                              <FiberManualRecordIcon sx={{fontSize: 10, color: "primary.main", padding: 0.5}}/>
                        ...
                        <Typography variant="subtitle1" color="secondary.dark">Public Attention, March 2013-July 2015</Typography>
